...
for (const launcherNeedle of [
  ...
  "source_head=",
  "source_commit_epoch",
  "binary_source_commit_epoch",
  "binary_source_commit_time=",
  "binary_mtime_epoch",
  "launch blocked: release binary is older than app source inputs",
  ...
  "GRAVITY_OMEGA_RENDER_PROFILE",
  "GRAVITY_OMEGA_GDK_BACKEND",
  "render_profile=",
  "gdk_backend=",
  "GDK_BACKEND",
  "GSK_RENDERER",
  ...
  "x11-safe",
  "launch failed: unknown GRAVITY_OMEGA_RENDER_PROFILE",
  "cd \"$app_root\"",
  "set +e",
