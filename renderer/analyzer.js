...
window.buildHTML = function(d,fname){
  ...
  <div class="r-hero">
    ...
    <div class="r-omega"><span class="omega-serif">Ω</span></div>
  ...
  <div class="r-content">
    ...
    <div class="r-seal">
      ...
      <div class="r-strace"><span>TRACE ID:</span> &nbsp; ${esc(d.trace_id||meta.trace||'<span class="omega-serif">Ω</span>-1.0-REPORT')}</div>

      <div class="r-strace"><span>SOURCE:</span> &nbsp; ${esc(fname)}</div>

      <div class="r-witness">${esc(d.witness)}</div>

      <div class="r-sstatus">STATUS: SEALED — ${esc(d.trace_id||'<span class="omega-serif">Ω</span>-1.0')} ✓</div>

    </div>

    <div class="r-footer"><span><span class="omega-serif">Ω</span></span> &nbsp; Gravity Omega &nbsp;·&nbsp; Veritas Report Generator &nbsp;·&nbsp; <span>v1.0</span></div>
